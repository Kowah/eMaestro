package fr.istic.univ_rennes1.diengadama.mabdemaestro;
...
import fr.istic.univ_rennes1.diengadama.mabdemaestro.fragment.CustomEmpDialogFragment.CustomEmpDialogFragmentListener;
import fr.istic.univ_rennes1.diengadama.mabdemaestro.fragment.EmpAddFragment;
import fr.istic.univ_rennes1.diengadama.mabdemaestro.fragment.EmpListFragment;
...
public class MainActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Appel de la classe SymbolesDAO comme MusiqueDAO
		SymbolesDAO symbDAO = new SymbolesDAO(this);

		//Initially loads symboles
		if(symbDAO.getSymboles().size() <= 0)
			symbDAO.loadSymboles();

		MusiqueDAO deptDAO = new MusiqueDAO(this);

		//Initially loads musique
		if(deptDAO.getMusiques().size() <= 0)
			deptDAO.loadMusiques();
